...
public class ParserLargeOutputTests : IClassFixture<AssemblyResourcesTestFixture>
{
  private readonly AssemblyResourcesTestFixture _resourcesTestFixture;

  public ParserLargeOutputTests(AssemblyResourcesTestFixture resourcesTestFixture)
  {
  ...
  public void MetricsTests_LargeOutput_Parse_Passes()
  {
    ...
    var expectedMetrics = GetLargeOutputMetrics();
  ...
  private static Metric[] GetLargeOutputMetrics()
  {
    return new Metric[] 
    { 
      new GaugeMetric(
